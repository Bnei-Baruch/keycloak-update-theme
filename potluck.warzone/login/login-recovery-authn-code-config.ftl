    ...
    <form action="${url.loginAction}" class="${properties.kcFormGroupClass!}" id="kc-recovery-codes-settings-form" method="post">
        ...
        <div class="mt-6 flex flex-wrap items-center gap-4 w-full">
            <#if isAppInitiatedAction??>
                <button type="submit"
                    class="px-8 py-2.5 transition rounded-lg border-2 hover:bg-purple-50 border-purple-400 text-center text-purple-600 w-full md:w-max"
                    id="cancelRecoveryAuthnCodesBtn" name="cancel-aia" value="true">${msg("recovery-codes-action-cancel")}
                </button>
                <input type="submit"
                    class="px-8 py-2.5 cursor-pointer transition disabled:cursor-default disabled:bg-purple-400 bg-purple-600 hover:bg-purple-500 text-white w-full md:w-max rounded-lg"
