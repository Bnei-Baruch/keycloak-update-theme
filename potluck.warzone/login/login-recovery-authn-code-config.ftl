...
<#elseif section = "form">
    ...
    <div class="my-10 flex items-center gap-4">
        <button id="printRecoveryCodes" class="inline-flex text-sm items-center gap-2 ring-1 py-0.5 px-2 rounded-md text-purple-600 ring-purple-600 hover:bg-purple-50" type="button" onclick="printRecoveryCodes()">
            <span>
        ...
        <button id="downloadRecoveryCodes" class="inline-flex text-sm items-center gap-2 ring-1 py-0.5 px-2 rounded-md text-purple-600 ring-purple-600 hover:bg-purple-50" type="button" onclick="downloadRecoveryCodes()">
            <span>
        ...
        <button id="copyRecoveryCodes" class="inline-flex text-sm items-center gap-2 ring-1 py-0.5 px-2 rounded-md text-purple-600 ring-purple-600 hover:bg-purple-50" type="button" onclick="copyRecoveryCodes()">
            <span>
